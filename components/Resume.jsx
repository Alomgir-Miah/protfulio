        ...
        <div className="row">
          <div className="col-xxl-6 col-lg-6">
            ...
            <div className="education position-relative fade_up">
              ...
              <div className="small_yellow_border_main">
                <p className="bachelor">Habiganj Brindaban Govt College</p>
                <p className="cursus university">
                2021 — 2024
                </p>
                <p className="cursus">
                  habiganj brindaban govt college i study i get good results i say a lot i see it works.
                </p>
              </div>
            </div>
            <div className="education position-relative fade_up">
              ...
              <div className="small_yellow_border_main">
                <p className="bachelor">creative it institute</p>
                <p className="cursus university">
          ...
          <div className="col-xxl-6 col-lg-6">
            ...
            <div className="education position-relative fade_up">
              ...
              <div className="small_yellow_border_main">
                <p className="bachelor">LEAD DESIGN</p>
                <p className="cursus university"> 2024 - Current</p>
                <p className="cursus">
                Lead Design & Development with expertise in UI frameworks like Bootstrap and Tailwind CSS.
                I also work with JavaScript libraries such as jQuery (plugins) and React, including Router DOM.
                Design Tools: Figma, Canva, and experience with Node.js, including building Chatting Apps."
                </p>
              </div>
            </div>
            ...
            <div className="education position-relative fade_up">
              ...
              <div className="small_yellow_border_main">
                ...
                <p className="cursus university"> 2021 - 2024</p>
                <p className="cursus">
                Junior Design & Development with expertise in UI frameworks like Bootstrap and Tailwind CSS.
                I also work with JavaScript libraries such as jQuery (plugins) and React, including Router DOM.
                Design Tools: Figma, Canva, and experience with Node.js, including building Chatting Apps."
                </p>
              </div>
      ...
      <section className="design-skill-section">
        ...
        <div className="design-skill-sub-section">
          ...
          <div className="design-skills-img-main photoshop flip_up">
            <img className=" react" src={PhotoShopImg} alt="photoshop-img" />
          ...
          <div className="design-skills-img-main invision flip_up">
            <img className=" bootstrap" src={InvisionImg} alt="invision-img" />
