...
const Home = () => {
  //Text
  const firstTexts = ["Designer", "Developer", "React Developer"];
  const secondTexts = [
    "React Developer",
    "Frond-End React Developer",
  ];
    ...
    <>
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          <img className="zoom_in" src="imgProfile/images.jpg" alt="profile-img" />
          <h1 className="fade_up">
            Alomgir<span>Miah</span>
          </h1>
          <h2 className="designer fade_up">{firstTexts[firstTextIndex]}</h2>
          <div className="profile-media-icons-main fade_up">
            <Link to="mdalomgir2156@gmail.com" className="profile-media-icons">
        ...
        <div>
          <div id="wrap">
          {/* <a className=" mycv" href=" public/cb/myCv.png" download= 'my cv '>Cv Download</a> */}
...
<div class="">
  <label class="label">
    ...
    <a className="title" href="cv/myCv.png" download= 'myCv '> Download</a>
        ...
        <section className="section-one overflow-hidden" id="home">
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              <h2 className="Alomgir-main-text zoom_in">
                Alomgir <span>Miah</span>
              </h2>
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <img
                ...
                alt="circular-img"
              />
              <img className=" AlomgirP" src="imgProfile/images.jpg" alt="img" />
            </div>
          </div>
        </section>
        {/* <!-- ====================================== Section Marquee ===================================== --> */}
